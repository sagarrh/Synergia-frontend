        ...
        <div className="grid gap-6 items-center">
          <div className="flex flex-col justify-center space-y-8 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-black-200 md:text-xl dark:text-black-100 mx-auto">
            ...
            <div className="w-full max-w-full space-y-4 mx-auto">
              <div className="grid grid-cols-3 gap-8">
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  <div className="p-2 bg-blue-300 bg-opacity-50 rounded-full">
                    <InboxIcon className="text-black h-6 w-6 mb-2 opacity-75" />
                  </div>
                  <h2 className="text-xl font-bold text-black">Smart Inbox</h2>
                  <p className="text-black-200 dark:text-black-100">
                ...
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  ...
                  <h2 className="text-xl font-bold text-black">Seamless Integration</h2>
                  <p className="text-black-200 dark:text-black-100">
                ...
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  <div className="p-2 bg-blue-300 bg-opacity-50 rounded-full">
                    <SettingsIcon className="text-black h-6 w-6 mb-2 opacity-75" />
                  </div>
                  <h2 className="text-xl font-bold text-black">Advanced Customization</h2>
                  <p className="text-black-200 dark:text-black-100">
                ...
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  <div className="p-2 bg-blue-300 bg-opacity-50 rounded-full">
                    <SearchIcon className="text-black h-6 w-6 mb-2 opacity-75" />
                  </div>
                ...
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  <div className="p-2 bg-blue-300 bg-opacity-50 rounded-full">
                    <LockIcon className="text-black h-6 w-6 mb-2 opacity-75" />
                  </div>
                  <h2 className="text-xl font-bold text-black">Reliable Security</h2>
                  <p className="text-black-200 dark:text-black-100">
                ...
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  <div className="p-2 bg-black bg-opacity-50 rounded-full">
                    <CombineIcon className="text-black h-6 w-6 mb-2 opacity-75" />
                  </div>
                  <h2 className="text-xl font-bold text-black">Easy Collaboration</h2>
                  <p className="text-black-200 dark:text-black-100">
